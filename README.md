...
이 저장소는 현재 원티드 이벤트용 제품 방향을 검증하는 샘플링 단계입니다. 완성 제품을 구현하기 전에 아래 질문에 답하는 것이 목적입니다.
...
실제 RSS 수집, 인증, LLM 연동, 벡터 검색, 배포는 아직 구현하지 않습니다. 샘플 데이터 6개로 하나의 vertical slice를 설명하고, go/no-go 기준을 통과한 뒤 기능별 구현 브랜치로 나눕니다.
